...
namespace TestAutomation.UIMap.TabSearchTile.clickOKBtnFrmTabPaxLayer_MapClasses
{
    ...
    public partial class clickOKBtnFrmTabPaxLayer_Map:logWriter
    {
        
        /// <summary>
        /// clickOKBtnFrmTabPaxLayer_Method
        /// </summary>
        public void clickOKBtnFrmTabPaxLayer_Method()
        {
            #region Variable Declarations
            HtmlDiv uIOKPane = this.UIVillaHolidaysThatYouWindow.UIVillaHolidaysThatYouDocument.UIOKPane;
            #endregion

            try
            {
                // Click 'OK' pane
                Mouse.Click(uIOKPane, new Point(34, 11));
                WriteLogs("PASS : Clicked \"OK\" Button from Tablet Pax Layer.");
            }
            catch (AssertFailedException ex)
            {
                takeImage("clickOKBtnFrmTabPaxLayer");
                WriteLogs("FAIL : Could Not Click \"OK\" Button from Tablet Pax Layer.");
        ...
        public HtmlDiv UIOKPane
        {
            get
            {
                if ((this.mUIOKPane == null))
                {
                    ...
                    #region Search Criteria
                    this.mUIOKPane.SearchProperties[HtmlDiv.PropertyNames.Id] = "paxOkBtn";
                    this.mUIOKPane.FilterProperties[HtmlDiv.PropertyNames.InnerText] = "OK";
                    this.mUIOKPane.FilterProperties[HtmlDiv.PropertyNames.Class] = "orangeBtn";
                    this.mUIOKPane.FilterProperties[HtmlDiv.PropertyNames.ControlDefinition] = "class=\"orangeBtn\" id=\"paxOkBtn\"";
                    this.mUIOKPane.WindowTitles.Add("Villa Holidays That You’ll Love More | Villa Plus");
                    #endregion
                }
