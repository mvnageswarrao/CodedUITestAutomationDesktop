...
namespace TestAutomation.UIMap.TabSearchTile.clickOKfromTabCalender_MapClasses
{
    ...
    public partial class clickOKfromTabCalender_Map:logWriter
    {
        
        /// <summary>
        /// clickOKfromTabCalender_Method
        /// </summary>
        public void clickOKfromTabCalender_Method()
        {
            ...
            {
                // Click 'OK' button
                Mouse.Click(uIOKButton, new Point(35, 19));
                WriteLogs("PASS : Clicked \"OK\" Button From Tablet Calender.");
            }
            catch (AssertFailedException ex)
            {
                takeImage("clickOKfromTabCalender");
                WriteLogs("FAIL : Could Not Click \"OK\" Button From Tablet Calender.");
        ...
        public HtmlButton UIOKButton
        {
            get
            {
                if ((this.mUIOKButton == null))
                {
                    ...
                    #region Search Criteria
                    this.mUIOKButton.SearchProperties[HtmlButton.PropertyNames.Id] = "cmdOkBtn";
                    ...
                    this.mUIOKButton.FilterProperties[HtmlButton.PropertyNames.Class] = "orangeBtn ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all";
                    this.mUIOKButton.FilterProperties[HtmlButton.PropertyNames.ControlDefinition] = "class=\"orangeBtn ui-datepicker-close ui-";
