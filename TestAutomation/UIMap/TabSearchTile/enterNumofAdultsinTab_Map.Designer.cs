...
namespace TestAutomation.UIMap.TabSearchTile.enterNumofAdultsinTab_MapClasses
{
    ...
    public partial class enterNumofAdultsinTab_Map:logWriter
    {
        
        /// <summary>
        /// enterNumofAdultsinTab_Method - Use 'enterNumofAdultsinTab_MethodParams' to pass parameters into this method.
        /// </summary>
        public int enterNumofAdultsinTab_Method(int MaxOCCUPANCY)
        {
            #region Variable Declarations
            HtmlEdit uIItemEdit = this.UIVillaHolidaysThatYouWindow.UIVillaHolidaysThatYouDocument.UIAdultsPane.UIItemEdit;
            #endregion

            //int Numofitems = MaxOCCUPANCY / 2;
            int Numofitems = 10;
            Random rnd = new Random();
            int randomAdultsNum = rnd.Next(2, Numofitems);
            int NumofAdultsSelected = 0;

            try
            {
                // Type '3' in text box
                uIItemEdit.Text =Convert.ToString(randomAdultsNum);
                NumofAdultsSelected = randomAdultsNum;
                WriteLogs("PASS : \"" + NumofAdultsSelected + "\" Adults Selected.");
            }
            catch (AssertFailedException ex)
            {
                takeImage("enterNumofAdultsinTab");
                WriteLogs("FAIL : Could Not Select Num of Adults in Tablet Search Tile.");
        ...
        #region Properties
        public virtual enterNumofAdultsinTab_MethodParams enterNumofAdultsinTab_MethodParams
        {
            get
            {
                if ((this.menterNumofAdultsinTab_MethodParams == null))
                {
                    this.menterNumofAdultsinTab_MethodParams = new enterNumofAdultsinTab_MethodParams();
                }
                return this.menterNumofAdultsinTab_MethodParams;
            }
        }
        ...
        #region Fields
        private enterNumofAdultsinTab_MethodParams menterNumofAdultsinTab_MethodParams;
    ...
    /// <summary>
    /// Parameters to be passed into 'enterNumofAdultsinTab_Method'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "11.0.60315.1")]
    public class enterNumofAdultsinTab_MethodParams
    {
    ...
    public class UIVillaHolidaysThatYouDocument : HtmlDocument
    {
        ...
        #region Properties
        public UIAdultsPane UIAdultsPane
        {
            get
            {
                if ((this.mUIAdultsPane == null))
                {
                    this.mUIAdultsPane = new UIAdultsPane(this);
                }
                return this.mUIAdultsPane;
            }
        }
        #endregion
        
        #region Fields
        private UIAdultsPane mUIAdultsPane;
        #endregion
    }
    
    [GeneratedCode("Coded UITest Builder", "11.0.60315.1")]
    public class UIAdultsPane : HtmlDiv
    {
        
        public UIAdultsPane(UITestControl searchLimitContainer) : 
                base(searchLimitContainer)
        {
            #region Search Criteria
            this.SearchProperties[HtmlDiv.PropertyNames.Id] = "divAdults";
            this.FilterProperties[HtmlDiv.PropertyNames.InnerText] = "Adults";
            this.FilterProperties[HtmlDiv.PropertyNames.Class] = "spinnerContainer";
            this.FilterProperties[HtmlDiv.PropertyNames.ControlDefinition] = "class=\"spinnerContainer\" id=\"divAdults\" style=\"width: 185px; height: 35px;\"";
            this.WindowTitles.Add("Villa Holidays That You’ll Love More | Villa Plus");
            #endregion
        }
