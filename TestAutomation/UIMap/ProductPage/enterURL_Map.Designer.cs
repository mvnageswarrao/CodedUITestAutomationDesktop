    ...
    public partial class enterURL_Map:logWriter
    {
        ...
        public void enterURL_Method(string strURL)
        {
            ...
            try
            {
                ...
                uIBlankPageWindowsInteWindow.WaitForControlReady(15000);
                if (strURL.Contains("product.aspx?villaid="))
                {
                    WriteLogs("PASS : Product Page with given id is Opened Successfully. : VERIFICATION");

                }
                else
                {
                    WriteLogs("PASS : Home page is Opened Successfully. : VERIFICATION");
                }
            }
            catch (AssertFailedException ex)
            {
                takeImage("enterURL");
                WriteLogs("FAIL : Page with given URL is not Opened Successfully. : VERIFICATION");
