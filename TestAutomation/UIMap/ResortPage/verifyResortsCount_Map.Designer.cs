...
namespace TestAutomation.UIMap.ResortPage.verifyResortsCount_MapClasses
{
    ...
    public partial class verifyResortsCount_Map:logWriter
    {
        
        /// <summary>
        /// verifyResortsCount_Method - Use 'verifyResortsCount_MethodExpectedValues' to pass parameters into this method.
        /// </summary>
        public void verifyResortsCount_Method(string resortName, string resortCount)
        {
            ...
            // Verify that the 'InnerText' property of 'Vale do Lobo - 11 Villas Vale do' pane contains '
            //
            ...
            // Find out more
            // '
            //StringAssert.Contains(uIValedoLobo11VillasVaPane.InnerText, this.verifyResortsCount_MethodExpectedValues.UIValedoLobo11VillasVaPaneInnerText);

            resortName = resortName.Trim();
            resortCount = resortCount.Trim();
            string resortCountwithName = resortName + " - " + resortCount;
            try
            {
                StringAssert.Contains(uIValedoLobo11VillasVaPane.InnerText, resortCountwithName);
                WriteLogs("PASS : Resorts Count : " + resortCountwithName + " [Displayed On Page] ");
            }
            catch (AssertFailedException ex)
            {
                WriteLogs("FAIL : Resorts Count : " + resortCountwithName + " [Displayed On Page] ");
                WriteLogs("-----------------" + ex.Message.ToString());
            }
        }

        public void verifyResortsCountModified_Method(string resortName, string resortCount)
        {
            #region Variable Declarations
            HtmlDiv uIValedoLobo11VillasVaPane = this.UIHolidayVillaResortsiWindow.UIHolidayVillaResortsiDocument.UIListViewTabPane.UIValedoLobo11VillasVaPane;
            #endregion
            ...
            {
                WriteLogs("FAIL : Resorts Count : " + resortCountwithName + " [Not Displayed On Page]");
            }
        }

        #region Properties
        public virtual verifyResortsCount_MethodExpectedValues verifyResortsCount_MethodExpectedValues
        {
            get
            {
                if ((this.mverifyResortsCount_MethodExpectedValues == null))
                {
                    this.mverifyResortsCount_MethodExpectedValues = new verifyResortsCount_MethodExpectedValues();
                }
                return this.mverifyResortsCount_MethodExpectedValues;
            }
        }
        ...
        #region Fields
        private verifyResortsCount_MethodExpectedValues mverifyResortsCount_MethodExpectedValues;
    ...
    /// <summary>
    /// Parameters to be passed into 'verifyResortsCount_Method'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "11.0.50727.1")]
    public class verifyResortsCount_MethodExpectedValues
    {
    ...
    public class UIListViewTabPane : HtmlDiv
    {
                ...
                base(searchLimitContainer)
        {
            ...
            this.FilterProperties[HtmlDiv.PropertyNames.Class] = "font11 overflow-hidden padding0 ui-tabs-panel ui-widget-content ui-corner-bottom";
        ...
        public HtmlDiv UIValedoLobo11VillasVaPane
        {
            get
            {
                if ((this.mUIValedoLobo11VillasVaPane == null))
                {
                    ...
                    this.mUIValedoLobo11VillasVaPane.FilterProperties[HtmlDiv.PropertyNames.InnerText] = "\r\n\r\nVale do Lobo - 11 Villas\r\n\r\n\r\n\r\nVale";
                    this.mUIValedoLobo11VillasVaPane.FilterProperties[HtmlDiv.PropertyNames.Title] = null;
                    ...
                    this.mUIValedoLobo11VillasVaPane.FilterProperties[HtmlDiv.PropertyNames.TagInstance] = "1";
                    this.mUIValedoLobo11VillasVaPane.WindowTitles.Add("Holiday Villa Resorts in Algarve - Villa Plus");
                    #endregion
                }
