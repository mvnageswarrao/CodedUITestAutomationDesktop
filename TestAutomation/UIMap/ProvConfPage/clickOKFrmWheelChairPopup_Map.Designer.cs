...
namespace TestAutomation.UIMap.ProvConfPage.clickOKFrmWheelChairPopup_MapClasses
{
    ...
    public partial class clickOKFrmWheelChairPopup_Map:logWriter
    {
        
        /// <summary>
        /// clickOKFrmWheelChairPopup_Method
        /// </summary>
        public void clickOKFrmWheelChairPopup_Method()
        {
            #region Variable Declarations
            HtmlInputButton uIOKButton = this.UIVillaPlusHolidayBookWindow.UIVillaPlusHolidayBookDocument.UIIfrmWheelChairFrame.UIWheelchairAssistanceDocument.UIOKButton;
            #endregion
            ...
            try
            {
                ...
                WriteLogs("PASS : \"OK\" Button is Clicked From \"Reduced mobility or wheelchair assistance\" Popup.");
            }
            catch (AssertFailedException ex)
            {
                takeImage("clickOKFrmWheelChairPopup");
                WriteLogs("FAIL : Could not Click \"OK\" Button From \"Reduced mobility or wheelchair assistance\" Popup.");
        ...
        public HtmlInputButton UIOKButton
        {
            get
            {
                if ((this.mUIOKButton == null))
                {
                    ...
                    #region Search Criteria
                    this.mUIOKButton.SearchProperties[HtmlButton.PropertyNames.Id] = "ctl00_ContentPlaceHolder1_imgBtnOk";
                    this.mUIOKButton.SearchProperties[HtmlButton.PropertyNames.Name] = "ctl00$ContentPlaceHolder1$imgBtnOk";
                    this.mUIOKButton.FilterProperties[HtmlButton.PropertyNames.Type] = "image";
                    this.mUIOKButton.FilterProperties.Add(new PropertyExpression("Src", "/imgs/vp/buttons/okOFF.gif", PropertyExpressionOperator.Contains));
                    this.mUIOKButton.FilterProperties[HtmlButton.PropertyNames.Title] = "Ok";
                    this.mUIOKButton.FilterProperties[HtmlButton.PropertyNames.ControlDefinition] = "name=\"ctl00$ContentPlaceHolder1$imgBtnOk";
                    this.mUIOKButton.WindowTitles.Add("Villa Plus - Holiday Booking Details");
                    #endregion
                }
