...
namespace TestAutomation.UIMap.SearchTile.clickSearchBtn_MapClasses
{
    ...
    public partial class clickSearchBtn_Map:logWriter
    {
        
        /// <summary>
        /// clickSearchBtn_Method
        /// </summary>
        public void clickSearchBtn_Method()
        {
            #region Variable Declarations
            HtmlInputButton uISearchButton = this.UIVillaHolidaysThatYouWindow.UIVillaHolidaysThatYouDocument.UISearchButton;
            #endregion

            try
            {
                // Click 'Search' button
                Mouse.Click(uISearchButton, new Point(29, 10));
                WriteLogs("PASS : Clicked \"Search\" button From Search tile.");
            }
            catch (AssertFailedException ex)
            {
                takeImage("clickSearchBtn");
                WriteLogs("FAIL : Could Not Click \"Search\" Button.");
        ...
        public HtmlInputButton UISearchButton
        {
            get
            {
                if ((this.mUISearchButton == null))
                {
                    ...
                    this.mUISearchButton.SearchProperties[HtmlButton.PropertyNames.Name] = "ctl00$MainContent$quickSearch$btnSearch";
                    ...
                    this.mUISearchButton.FilterProperties[HtmlButton.PropertyNames.Class] = "button font13 bold";
                    this.mUISearchButton.FilterProperties[HtmlButton.PropertyNames.ControlDefinition] = "name=\"ctl00$MainContent$quickSearch$btnS";
                    this.mUISearchButton.WindowTitles.Add("Villa Holidays That You’ll Love More | Villa Plus");
                    #endregion
                }
