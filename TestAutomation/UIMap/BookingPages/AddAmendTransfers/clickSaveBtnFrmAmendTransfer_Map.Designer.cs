...
namespace TestAutomation.UIMap.BookingPages.AddAmendTransfers.clickSaveBtnFrmAmendTransfer_MapClasses
{
    ...
    public partial class clickSaveBtnFrmAmendTransfer_Map:logWriter
    {
        
        /// <summary>
        /// clickSaveBtnFrmAmendTransfer_Method
        /// </summary>
        public void clickSaveBtnFrmAmendTransfer_Method(string strURL)
        {
            #region Variable Declarations
            HtmlInputButton uISaveFlight1TransfersButton = this.UIYourHolidaySummaryWiWindow.UIYourHolidaySummaryDocument.UIAmendTransferSelectiFrame.UIPrivateTransfersDocument.UISaveFlight1TransfersButton;
            #endregion

            try
            {
                // Click 'Save Flight1 Transfers' button
                Mouse.Click(uISaveFlight1TransfersButton, new Point(85, 13));
                WriteLogs("PASS : Clicked \"Save Transfer\" Button From Amend Transfers Pane.");
            }
            catch (AssertFailedException ex)
            {
                takeImage("clickSaveBtnFrmAmendTransfer");
                WriteLogs("FAIL : Could Not Click \"Save Transfer\" Button From Amend Transfer Pane.");
    ...
    public class UIPrivateTransfersDocument : HtmlDocument
    {
        ...
        #region Properties
        public HtmlInputButton UISaveFlight1TransfersButton
        {
            get
            {
                if ((this.mUISaveFlight1TransfersButton == null))
                {
                    this.mUISaveFlight1TransfersButton = new HtmlInputButton(this);
                    #region Search Criteria
                    this.mUISaveFlight1TransfersButton.SearchProperties.Add(new PropertyExpression(HtmlButton.PropertyNames.Id, "_btnImgSaveTrans", PropertyExpressionOperator.Contains));
                    this.mUISaveFlight1TransfersButton.SearchProperties.Add(new PropertyExpression(HtmlButton.PropertyNames.Name, "$btnImgSaveTrans", PropertyExpressionOperator.Contains));
                    this.mUISaveFlight1TransfersButton.FilterProperties.Add(new PropertyExpression(HtmlButton.PropertyNames.DisplayText, "Save", PropertyExpressionOperator.Contains));
                    this.mUISaveFlight1TransfersButton.FilterProperties[HtmlButton.PropertyNames.Type] = "submit";
                    this.mUISaveFlight1TransfersButton.FilterProperties.Add(new PropertyExpression(HtmlButton.PropertyNames.Title, "Save", PropertyExpressionOperator.Contains));
                    this.mUISaveFlight1TransfersButton.FilterProperties.Add(new PropertyExpression(HtmlButton.PropertyNames.Class, "button", PropertyExpressionOperator.Contains));
                    this.mUISaveFlight1TransfersButton.WindowTitles.Add("Your Holiday Summary");
                    #endregion
                }
                return this.mUISaveFlight1TransfersButton;
            }
        }
        #endregion
        
        #region Fields
        private HtmlInputButton mUISaveFlight1TransfersButton;
        #endregion
    }
}
