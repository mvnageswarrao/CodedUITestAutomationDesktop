...
namespace TestAutomation.UIMap.BookingPages.AddAmendTransfers.clickAmendForaTransfer_MapClasses
{
    ...
    public partial class clickAmendForaTransfer_Map:logWriter
    {
        
        /// <summary>
        /// clickAmendForaTransfer_Method
        /// </summary>
        public void clickAmendForaTransfer_Method()
        {
            #region Variable Declarations
            HtmlInputButton uIAmendButton = this.UIYourHolidaySummaryWiWindow.UIYourHolidaySummaryDocument.UIAmendTransferSelectiFrame.UIPrivateTransfersDocument.UIAmendButton;
            #endregion
            
            try
            {
                // Click 'Amend' button
                Mouse.Click(uIAmendButton, new Point(28, 12));
                WriteLogs("PASS : Clicked \"Amend\" Button For a Transfer.");
            }
            catch (AssertFailedException ex)
            {
                takeImage("clickAmendForaTransfer");
                WriteLogs("FAIL : Could Not Click \"Amend\" Button For a Transfer.");
    ...
    public class UIPrivateTransfersDocument : HtmlDocument
    {
        ...
        #region Properties
        public HtmlInputButton UIAmendButton
        {
            get
            {
                if ((this.mUIAmendButton == null))
                {
                    this.mUIAmendButton = new HtmlInputButton(this);
                    #region Search Criteria
                    this.mUIAmendButton.SearchProperties.Add(new PropertyExpression(HtmlButton.PropertyNames.Id, "_btnAmend", PropertyExpressionOperator.Contains));
                    this.mUIAmendButton.SearchProperties.Add(new PropertyExpression(HtmlButton.PropertyNames.Name, "$btnAmend", PropertyExpressionOperator.Contains));
                    this.mUIAmendButton.FilterProperties[HtmlButton.PropertyNames.DisplayText] = "Amend";
                    this.mUIAmendButton.FilterProperties[HtmlButton.PropertyNames.Type] = "submit";
                    this.mUIAmendButton.FilterProperties[HtmlButton.PropertyNames.Title] = "Amend";
                    this.mUIAmendButton.FilterProperties.Add(new PropertyExpression(HtmlButton.PropertyNames.Class, "button", PropertyExpressionOperator.Contains));
                    this.mUIAmendButton.WindowTitles.Add("Your Holiday Summary");
                    #endregion
                }
                return this.mUIAmendButton;
            }
        }
        #endregion
        
        #region Fields
        private HtmlInputButton mUIAmendButton;
        #endregion
    }
}
