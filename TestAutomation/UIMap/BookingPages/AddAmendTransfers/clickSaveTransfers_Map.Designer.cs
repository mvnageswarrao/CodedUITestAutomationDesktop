...
namespace TestAutomation.UIMap.BookingPages.AddAmendTransfers.clickSaveTransfers_MapClasses
{
    ...
    public partial class clickSaveTransfers_Map:logWriter
    {
        
        /// <summary>
        /// clickSaveTransfers_Method
        /// </summary>
        public void clickSaveTransfers_Method(string strURL)
        {
            ...
            try
            {
                ...
                Mouse.Click(uISaveFlight1TransfersButton, new Point(68, 11));
                WriteLogs("PASS : Clicked \"Save Transfers\" Button.");
            }
            catch (AssertFailedException ex)
            {
                takeImage("clickSaveTransfers");
                WriteLogs("FAIL : Could Not Click \"Save Transfers\" Button.");
        ...
        public HtmlInputButton UISaveFlight1TransfersButton
        {
            get
            {
                if ((this.mUISaveFlight1TransfersButton == null))
                {
                    ...
                    #region Search Criteria
                    this.mUISaveFlight1TransfersButton.SearchProperties.Add(new PropertyExpression(HtmlButton.PropertyNames.Id, "_btnImgSaveExtra", PropertyExpressionOperator.Contains));
                    this.mUISaveFlight1TransfersButton.SearchProperties.Add(new PropertyExpression(HtmlButton.PropertyNames.Name, "$btnImgSaveExtra", PropertyExpressionOperator.Contains));
                    ...
                    this.mUISaveFlight1TransfersButton.FilterProperties[HtmlButton.PropertyNames.Class] = "button";
