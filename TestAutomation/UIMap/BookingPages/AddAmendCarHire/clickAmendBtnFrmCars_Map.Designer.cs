...
namespace TestAutomation.UIMap.BookingPages.AddAmendCarHire.clickAmendBtnFrmCars_MapClasses
{
    ...
    public partial class clickAmendBtnFrmCars_Map:logWriter
    {
        
        /// <summary>
        /// clickAmendBtnFrmCars_Method
        /// </summary>
        public void clickAmendBtnFrmCars_Method()
        {
            #region Variable Declarations
            HtmlDiv uIAmendPane = this.UIYourHolidaySummaryWiWindow.UIYourHolidaySummaryDocument.UIAmendCarHireFrame.UIAmendCarHireDocument.UIAmendPane;
            #endregion

            try
            {
                // Click 'Amend' pane
                Mouse.Click(uIAmendPane, new Point(34, 17));
                WriteLogs("PASS : Clicked \"Amend\" Button From Cars Popup.");
            }
            catch (AssertFailedException ex)
            {
                takeImage("clickAmendBtnFrmCars");
                WriteLogs("FAIL : Could Not Click \"Amend\" Button From Cars Popup.");
    ...
    public class UIAmendCarHireFrame : HtmlIFrame
    {
                ...
                base(searchLimitContainer)
        {
            ...
            this.FilterProperties.Add(new PropertyExpression(HtmlFrame.PropertyNames.PageUrl, "amendCarHire.aspx?packageType=", PropertyExpressionOperator.Contains));
    ...
    public class UIAmendCarHireDocument : HtmlDocument
    {
                ...
                base(searchLimitContainer)
        {
            ...
            this.FilterProperties.Add(new PropertyExpression(HtmlDocument.PropertyNames.PageUrl, "/code_net/booking/amendCarHire.aspx?packageType=", PropertyExpressionOperator.Contains));
            this.WindowTitles.Add("Your Holiday Summary");
            #endregion
        }
        
        #region Properties
        public HtmlDiv UIAmendPane
        {
            get
            {
                if ((this.mUIAmendPane == null))
                {
                    this.mUIAmendPane = new HtmlDiv(this);
                    #region Search Criteria
                    this.mUIAmendPane.SearchProperties.Add(new PropertyExpression(HtmlDiv.PropertyNames.Id, "AmendCar_", PropertyExpressionOperator.Contains));
                    this.mUIAmendPane.FilterProperties[HtmlDiv.PropertyNames.InnerText] = "Amend";
                    this.mUIAmendPane.FilterProperties[HtmlDiv.PropertyNames.Class] = "mycell orangeButtons cmdSelectACar";
                    this.mUIAmendPane.FilterProperties.Add(new PropertyExpression(HtmlDiv.PropertyNames.ControlDefinition, "class=\"mycell orangeButtons cmdSelectACar\"", PropertyExpressionOperator.Contains));
                    this.mUIAmendPane.WindowTitles.Add("Your Holiday Summary");
                    #endregion
                }
                return this.mUIAmendPane;
            }
        }
        #endregion
        
        #region Fields
        private HtmlDiv mUIAmendPane;
        #endregion
    }
}
