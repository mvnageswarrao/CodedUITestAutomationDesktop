...
namespace TestAutomation.UIMap.BookingPages.AddAmendCarHire.clickSelectBtnfrmCars_MapClasses
{
    ...
    public partial class clickSelectBtnfrmCars_Map:logWriter
    {
        
        /// <summary>
        /// clickSelectBtnfrmCars_Method
        /// </summary>
        public void clickSelectBtnfrmCars_Method()
        {
            #region Variable Declarations
            HtmlDiv uISelectPane = this.UIYourHolidaySummaryWiWindow.UIYourHolidaySummaryDocument.UIAmendCarHireFrame.UIAmendCarHireDocument.UISelectPane;
            #endregion

            try
            {
                // Click 'Select' pane
                Mouse.Click(uISelectPane, new Point(43, 23));
                WriteLogs("PASS : Clicked \"Select\" Button from Amend Cars.");
            }
            catch (AssertFailedException ex)
            {
                takeImage("clickSelectBtnfrmCars");
                WriteLogs("FAIL : Could Not Click \"Select\" Button From Amend Cars.");
        ...
        public HtmlDiv UISelectPane
        {
            get
            {
                if ((this.mUISelectPane == null))
                {
                    ...
                    #region Search Criteria
                    this.mUISelectPane.SearchProperties.Add(new PropertyExpression(HtmlDiv.PropertyNames.Id, "tRow_SelectButton_", PropertyExpressionOperator.Contains));
                    this.mUISelectPane.FilterProperties[HtmlDiv.PropertyNames.InnerText] = "Select";
                    this.mUISelectPane.FilterProperties[HtmlDiv.PropertyNames.Class] = "mycell orangeButtons cmdSelectACar";
                    this.mUISelectPane.FilterProperties.Add(new PropertyExpression(HtmlDiv.PropertyNames.ControlDefinition, "class=\"mycell orangeButtons cmdSelectACar", PropertyExpressionOperator.Contains));
