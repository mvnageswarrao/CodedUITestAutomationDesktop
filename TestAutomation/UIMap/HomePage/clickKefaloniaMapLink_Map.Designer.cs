...
namespace TestAutomation.UIMap.HomePage.clickKefaloniaMapLink_MapClasses
{
    ...
    public partial class clickKefaloniaMapLink_Map:logWriter
    {
        
        /// <summary>
        /// clickKefaloniaMapLink_Method
        /// </summary>
        public void clickKefaloniaMapLink_Method()
        {
            #region Variable Declarations
            HtmlAreaHyperlink uIKefaloniaHyperlink = this.UIVillaHolidaysThatYouWindow.UIVillaHolidaysThatYouDocument.UIDestMapCustom.UIKefaloniaHyperlink;
            #endregion

            // Click 'Kefalonia' link
            Mouse.Click(uIKefaloniaHyperlink, new Point(8, 8));
          string   chkURL = this.UIVillaHolidaysThatYouWindow.Uri.ToString();

          try
          {
              StringAssert.Contains(chkURL, "kefalonia");
              WriteLogs("PASS : Clicked on Kefalonia Map Linked.");
          }
          catch (Exception ex)
          {
              WriteLogs("FAIL : Clicked on Kefalonia Map Linked.");
    ...
    public class UIDestMapCustom : HtmlCustom
    {
        ...
        #region Properties
        public HtmlAreaHyperlink UIKefaloniaHyperlink
        {
            get
            {
                if ((this.mUIKefaloniaHyperlink == null))
                {
                    this.mUIKefaloniaHyperlink = new HtmlAreaHyperlink(this);
                    #region Search Criteria
                    this.mUIKefaloniaHyperlink.FilterProperties[HtmlHyperlink.PropertyNames.AbsolutePath] = "/kefalonia";
                    this.mUIKefaloniaHyperlink.FilterProperties[HtmlHyperlink.PropertyNames.Title] = "Kefalonia";
                    this.mUIKefaloniaHyperlink.FilterProperties.Add(new PropertyExpression(HtmlHyperlink.PropertyNames.Href, "/kefalonia", PropertyExpressionOperator.Contains));
                    this.mUIKefaloniaHyperlink.FilterProperties.Add(new PropertyExpression(HtmlHyperlink.PropertyNames.ControlDefinition, "title=\"Kefalonia\" href=\"/kefalonia\" ", PropertyExpressionOperator.Contains));
                    this.mUIKefaloniaHyperlink.WindowTitles.Add("Villa Holidays That You’ll Love More | Villa Plus");
                    #endregion
                }
        ...
        #region Fields
        private HtmlAreaHyperlink mUIKefaloniaHyperlink;
        #endregion
    }
}
