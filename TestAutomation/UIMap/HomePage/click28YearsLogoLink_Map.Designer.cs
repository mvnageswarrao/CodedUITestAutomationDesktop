...
namespace TestAutomation.UIMap.HomePage.click28YearsLogoLink_MapClasses
{
    ...
    public partial class click28YearsLogoLink_Map:logWriter
    {
        
        /// <summary>
        /// click28YearsLogoLink_Method
        /// </summary>
        public void click28YearsLogoLink_Method()
        {
            #region Variable Declarations
            HtmlImage uIItem28YearsEstablishImage = this.UIVillaHolidaysThatYouWindow.UIVillaHolidaysThatYouDocument.UIBook_with_confidencePane.UIItem28YearsEstablishImage;
            #endregion

            // Click '28 Years Established' image
            Mouse.Click(uIItem28YearsEstablishImage, new Point(43, 21));
            string chkURL = this.UIVillaHolidaysThatYouWindow.Uri.ToString();
            try
            {
                StringAssert.Contains(chkURL, "why-book-with-us");
                WriteLogs("PASS : Clicked on 28 Years logo from Footer Section.");
            }
            catch (Exception ex)
            {
                takeImage("click28YearsLogoLink");
                WriteLogs("FAIl : Clicked on 28 Years logo from Footer Section.");
    ...
    public class UIBook_with_confidencePane : HtmlDiv
    {
        ...
        #region Properties
        public HtmlImage UIItem28YearsEstablishImage
        {
            get
            {
                if ((this.mUIItem28YearsEstablishImage == null))
                {
                    this.mUIItem28YearsEstablishImage = new HtmlImage(this);
                    #region Search Criteria
                    this.mUIItem28YearsEstablishImage.SearchProperties[HtmlImage.PropertyNames.Alt] = "28 Years Established";
                    this.mUIItem28YearsEstablishImage.FilterProperties[HtmlImage.PropertyNames.AbsolutePath] = "/images/common/YearsEstablish.png";
                    this.mUIItem28YearsEstablishImage.FilterProperties.Add(new PropertyExpression(HtmlImage.PropertyNames.Src, "/images/common/YearsEstablish.png", PropertyExpressionOperator.Contains));
                    this.mUIItem28YearsEstablishImage.FilterProperties.Add(new PropertyExpression(HtmlImage.PropertyNames.ControlDefinition, "title=\"28 Years Established\" ", PropertyExpressionOperator.Contains));
                    this.mUIItem28YearsEstablishImage.WindowTitles.Add("Villa Holidays That You’ll Love More | Villa Plus");
                    #endregion
                }
                return this.mUIItem28YearsEstablishImage;
            }
        }
        #endregion
        
        #region Fields
        private HtmlImage mUIItem28YearsEstablishImage;
        #endregion
    }
}
