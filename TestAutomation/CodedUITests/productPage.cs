...
namespace TestAutomation
{
    ...
    public class productPage : logWriter
    {
        ...
        public void productPageVerf()
        {
            ...
            SqlDataReader dataReaderCount = null;
            ...
            foreach (string villaID in villaIDlst)
            {
                try
                {
                    ...
                    List<string> VillaTypes = new List<string>();
                   ...
                   // string initialCatalog1 = ConfigurationManager.AppSettings["InitialCatalog1"].ToString();
                    //string sqlQuery2 = "select count (*) as noOfImages from dbo.VillaImages where  ImageSizeNotation = 'L' and IsLive = '1' and VillaID ="+villaID;
                   // string sqlQuery2 = "select count (*) as noOfImages FROM [ImageRequests].[dbo].[VillaImages] where  ImageSizeNotation = 'L' and IsLive = '1' and VillaID =" + villaID;
                    string sqlQuery2 = "select count (*) as noOfImages FROM [dbo].[VillaImages] where  ImageSizeNotation = 'L' and IsLive = '1' and VillaID =" + villaID;
                   
                    int CountImage = 0;
                    //while (dataReaderCount.Read())
                    //{
                    //    CountImage=Convert.ToInt32(dataReaderCount[0]);
                    //}

                    DataSet dataset2 = getData.getdatafrmdtset("InitialCatalog1");
                   if(dataset2!=null && dataset2.Tables[0].Rows.Count>0)
                   {
                       CountImage = Convert.ToInt32(dataset2.Tables[0].Rows[0]["noOfImages"].ToString());
                   }
                    ...
                    ExpertComment = datatable1.Rows[0]["ExpertsComment"].ToString();
                    ...
                    datatable1 = dataset1.Tables[11];
                    for(int i=0;i< datatable1.Rows.Count;i++)
                    {
                        VillaTypes.Add(datatable1.Rows[i]["Villatypes"].ToString());
                    }
                    ...
                    runScript.verifyVillaTypes_Obj.verifyVillaTypes_Method(VillaTypes);
                    ...
                    runScript.verifyExpertComment_Obj.verifyExpertComment_Method(ExpertComment);
                    ...
                    runScript.clickCheckAvailabilitybutton_Obj.clickCheckAvailabilitybutton_Method();
        ...
        public void verifyProductMainPage(InitiateProductPage runScript, string villaID, string villaSummary, string villaHeader, string noOfCustGivenRating, List<string> villaFeatures, string CountImage)
        {
            ...
            runScript.verifyNoOfImages_Obj.verifyNoOfImages_Method(CountImage);
