...
namespace TestAutomation
{
    ...
    /// </summary>
    [CodedUITest]
    public class BookingB_PK_PayOnline:logWriter
    {
        //Booking Flow:Reach to Product Page from Villa Tab of Home Page>>Package HS page>>Pay Online using Master Card//
        public BookingB_PK_PayOnline()
        {
        }
        
        [TestMethod]
        public void BookingB_PK_Online_MasterCard()
        {
            ...
            #region Holiday Summary Page
                        ...
                        //*****Opening HS PK Page*****//
                        runScript.clickBookVillaPKonPopup_Obj.clickBookVillaPKonPopup_Method();
            ...
            #region LeadPax Page
                        ...
                        Boolean IsCheckInBagsPopupOpened = runScript.verifyCheckInBagsPopupOpened_Obj.verifyCheckInBagsPopupOpened_Method();
                        if (IsCheckInBagsPopupOpened == true)
                        {
