...
namespace TestAutomation
{
    ...
    public class BookingB_PK_WithAmends : logWriter
    {
        ...
        [TestMethod, TestCategory("DailyExeution")]
        public void BookingB_PK_WithAllAmends()
        {
            ...
            do
            {
                ...
                string StartDate1 = StartDate.ToString("MM/dd/yyyy");
                List<string> DatesList = new List<String>();
                sqlQuery = "exec dbo.QAsp_GetAvailableDates @strCentre='" + centerCode + "', @StartDate='" + StartDate1 + "',@EndDate='" + EndDate + "'";
                dataReader = getData.getData(sqlQuery, InitialCatalog);
                while (dataReader.Read())
                {
            ...
            string flttypeSupptxt = string.Empty;
            if (arr1.Length > 1)
            {
                flttypeSupptxt = arr1[2] + " " + arr1[3] + " " + arr1[4];
            }
